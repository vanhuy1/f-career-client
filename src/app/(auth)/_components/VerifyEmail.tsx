...
export default function VerifyEmailClient({ token }: VerifyEmailProps) {
  ...
  // Call verifyEmail when component mounts
  useEffect(() => {
    verifyEmail(token);
  }, [token, verifyEmail]);
  ...
  //     const response = await authService.resendVerification(payload)
  ...
  //     } else {
  //       setStatus("error")
  //       setMessage(response.message || "Failed to send a new verification email.")
  //     }
  //   } catch (error) {
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          ...
          <CardFooter className="flex justify-center">
            ...
            {/* {status === "expired" && (
              <Button className="w-full bg-blue-600 hover:bg-blue-700" onClick={handleResendVerification}>
