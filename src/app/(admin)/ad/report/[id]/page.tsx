...
import JobDetailSkeleton from '@/app/(public)/job/[id]/components/JobDetailSkeleton';
import JobDetailNotFound from '@/app/(public)/job/[id]/components/JobDetailNotFound';
import JobDescription from '@/app/(public)/job/[id]/components/JobDescription';
import JobBenefits from '@/app/(public)/job/[id]/components/JobBenefits';
import JobDetailSidebar from '@/app/(public)/job/[id]/components/JobDetailSidebar';
...
export default function ReportDetailPage() {
  ...
  return (
    <div className="space-y-6 p-6">
        ...
        <CardContent>
          <div className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Select
                value={newStatus}
                onValueChange={(v: ReportStatus) => setNewStatus(v)}
              >
      ...
      {/* Job Detail - reuse public job page components */}
      <Card>
        <CardHeader>
