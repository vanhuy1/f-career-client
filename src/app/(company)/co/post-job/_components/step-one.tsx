                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        if (value >= 0) {
                          ...
                          const newMin = Math.min(value, salaryRange[1]);
                          setSalaryRange([newMin, salaryRange[1]]);

                          // Show warning if user tried to set min > max
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        if (value >= 0) {
                          ...
                          const newMax = Math.max(value, salaryRange[0]);
                          setSalaryRange([salaryRange[0], newMax]);

                          // Show warning if user tried to set max < min
              ...
              <div className="flex w-full items-center sm:w-auto">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    const value = Number.parseInt(e.target.value);
                    if (value >= 0) {
                      // For min salary, set max to a reasonable upper limit
                      setSalaryRange([value, Math.max(value + 10000, 999999)]);
                    }
                  }}
                  className="w-full sm:w-24"
                  type="number"
                  ...
                  <CalendarComponent
                    ...
                    onSelect={(date) => {
                      if (date) {
                        ...
                        if (date > maxDate) {
                          toast.error(
                            'Deadline cannot be more than 30 days from today',
                          );
                          return;
                        }
