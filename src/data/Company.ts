...
export const companyData: Company[] = [
  {
    ...
    techStack: [
      { name: 'HTML 5', logo: '/tech-stack/html5.webp' },
      { name: 'CSS 3', logo: '/tech-stack/css3.png' },
      { name: 'JavaScript', logo: '/tech-stack/javascript.png' },
      { name: 'Ruby', logo: '/tech-stack/rudy.webp' },
      { name: 'Mixpanel', logo: '/tech-stack/mixpannel.webp' },
      { name: 'Framer', logo: '/tech-stack/framer.webp' },
    ],
    socialLinks: {
